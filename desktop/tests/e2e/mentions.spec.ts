...
// Fork-carried divergence from upstream #4913: upstream hides channel-member
// agents that appear in neither the managed list nor the relay directory
// ("stale"). This fork's standalone invite-flow agents are exactly such
// members (verified at the relay, absent from both local directories), so
// member agents stay mentionable — the relay vetted the membership.
